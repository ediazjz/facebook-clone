...
const Story = ({ image, profileSrc, title, avatarClass }) => {
  return (
    ...
    <div className="story h-40 w-24 mr-3 flex-shrink-0 relative bg-center bg-no-repeat rounded-xl shadow-md whitespace-normal cursor-pointer" style={{backgroundImage: `url(${image})`}}>
